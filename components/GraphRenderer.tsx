...
export default function GraphRenderer({ 
  ...
  useEffect(() => {
    ...
    const layout = cy.layout(mergedLayoutOptions as cytoscape.LayoutOptions);
    ...
    cy.on('pan', () => {
      ...
      const scaledLimit = basePanLimit * zoom;
  ...
  }, [isClient, nodes, edges, styleOverrides, layoutOptions, fitPadding]);
