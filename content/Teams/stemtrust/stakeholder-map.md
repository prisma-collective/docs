...
- Government/TETFund → Funds → University Admin → Opaque Allocation → Researcher
- Foreign Donors → Strict Conditions → Researcher
- Diaspora/Private Sector → Trust Gap → (blocked) → Researcher

**The Outcomes:**

- Researcher → Exit/Japa → Brain Drain
- Researcher → Success (Rare) → Local Innovation

**The Opportunity:**

- StemTrust Platform → Transparency → Diaspora
- StemTrust Platform → Direct Funding → Researcher
