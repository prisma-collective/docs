...
Note to reader: this is a real human being writing. No systems were overridden in the making. All systems living.

## Context

We onboard people into [process-domains](/processes/index.md) (literal subdomains.prisma.events) for the organising and facilitation of [transformation-oriented events](/patterns/action-learning%20journeys.md) in the [systems-change](/glossary/Place.md) space. 
...
3. ([EVALUATION](/processes/evaluation/index.md)) — [Timelining](/processes/process-infrastructuring/timelining/index.mdx) is p cool. We came last in a an ideathon organised by [singularitynet.io](https://www.singularitynet.io)'s [DeepFunding](https://blog.singularitynet.io/results-of-deep-funding-round-1-5aa37df06749) and then built it anyway because we needed it in [Accra](https://evaluate.prisma.events). 

4. ([ENACTION](/processes/enactment/index.md)) — Enact has a basic form -> to message queue -> to [list](https://enact.prisma.events) stack, which can be used to engage non-technical people in "contracts" (once we make it on-chain) - used for real-time governance (like what we try to incubate in an [ALJ](/patterns/action-learning%20journeys.md)). Think emergent learning, action-oriented... after several months of aligning multiple stakeholders at multiple levels of systems. 
