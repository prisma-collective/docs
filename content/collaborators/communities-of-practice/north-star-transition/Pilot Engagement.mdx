...
<PageGate requiredPassword="transition-labs-2025">
	...
	This is our offer for a first pilot, as an interim step toward co-designing custom data modelling (a less general schema) to collect more meaningfully structured data as a foundation for more specific insight generation.
