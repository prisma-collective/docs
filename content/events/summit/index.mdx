...
<Tabs items={['Summit Nested Systems', 'Projecting', 'Infrastructure']}>
  <Tabs.Tab>
...
The "hackathon" programme is in service to amplifying the visibility of Cardano developer talent, on-the-ground, across Wada partner regions, in the form of projects. In this way, a fourth and final organisational layer is required to be activated: the projects themselves. 
