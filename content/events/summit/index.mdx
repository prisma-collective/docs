...
The key detail here, from an organisational standpoint, is to recognise the Summit as a project nested within a larger system. In this way, we can bring order also to the "hackathon" programmes, delivered by Prisma, which are one part of summit.
...
The "hackathon" programme is brought in to serve the purpose of amplifying the visibility of Cardano developer talent, on-the-ground, across Wada partner regions. In this way, we are activating the fourth and final organisational layer, 
...
These projects will be regionally relevant, designed with regenerative principles in mind, and made possible by building a chain of facilitator capacity through the Wada hub network. 
