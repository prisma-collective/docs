...
description: Team $READS - Problem Statement and Thesis
---
...
Review:
- [Ground Truth findings](/team/$READS/ground-truth)
- [Formulated Insights](/team/$READS/formulate-insight)
...
Proceed to [Define Opportunity](/team/$READS/define-opportunity) to explore multiple solution approaches.
