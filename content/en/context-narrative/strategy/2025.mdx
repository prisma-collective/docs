...
6. Networking - accounting for the [practice-contributions](/processes/process-infrastructuring/practice-currencies) that bring [places](/glossary/Place) to life (measurements of participation, system effects, and DAOs)
...
1. [Evaluation](/processes/evaluation) - how we make visible value
	- Timeline interface making visible multiple layers of activity in an interactive front-end that becomes part of the [case-study](/patterns/case-study.md) (in-progress)
...
2. [Enaction](/processes/enactment) - how we activate self-organising
	...
	- [Practice](/glossary/Practice.md) participation mechanisms
	- Enaction-Evaluation interrelationship ([action-learning](/patterns/action-learning.md))
3. [Potentialising](/processes/ground-potentialising) - how we develop the potential of an [action-learning journey](action-learning journey)
	- Mapping hub network and ALJ instances - the interface for where each [case-study](/patterns/case-study.md) is published
