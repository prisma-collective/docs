...
Reflection is also important on the level of your own contributions to the team you're part of. Working in a [process-oriented](/context-narrative/clarifying/object-vs-process-lens) way necessarily means there is an inner dimension to the work. Working to complete a project, without reflecting on where your contributions are coming from, is likely to result in just the completion of a project. One thing that makes certain projects more regenerative is when team members and the project (and its environment) co-evolve together, throughout its development. This can only happen when there is a level of awareness of the possibility of such relationship, and that happens through reflection. This is also part of the depth our [publishing](/patterns/case-study) tooling has been designed for. 
