...
## What is timelining?
Timelining is the process of building up a timeline of an [action-learning journey](/en/patterns/action-learning%20journeys) (ALJ). Timelining uses multiple sources of data, and collects different kinds of action-led contributions. The basic premise is for it to be highly adaptable, catering to different groups' values and intentions.
## Why
Each ALJ is an evolutionary process. Timelining is one way of making this process visible. Making this visible serves learning. As when you journal to notice patterns in your thinking, cohorts can *timeline* (perform timelining) to notice patterns in their actions. Timelining is one of the ways we aim to support the formation of *evolutionary* organisations. 
## How
...
When the [act](/processes/enactment) of making a decision, in the moment, is the same as making the timelining contribution, it becomes a way for groups to participate in, record, and evolve how they organise, all in the same flow. By engaging with timelining, they are choosing to actively participate in the emergence that arises from their self-organising efforts, each participant's experience the signal that indicates aliveness of a living system in-becoming.
