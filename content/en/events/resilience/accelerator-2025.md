...
We all have the same problem of needing to learn how to \[be in right relationship with place/ steward ecosystems].
...
How in touch with the orgs are you after the accelerator? Not as much as they'd like to be.
...
> The river project is a project of citizen science applied to stewarding the health of a local river, which is currently a regional governance priority. The idea was to combine multiple data sources, such as satellite data, as well as in-person data acquisition (citizen science), to feed a generative AI model that could language the health of the river using discrete data and therefore support dialogue within the context of policy and decision-making. 
