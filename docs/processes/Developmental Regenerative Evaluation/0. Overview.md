...
As the term suggests, it is about finding the value in what has been done. 
...
2. **Multi-perspectival:** Co-creative processes emerging from context are bound to multi-capital lens to valuing flows of energy. Our approach is premised on *seeing, valuing and developing all forms of capital* - not just financial and economic.
