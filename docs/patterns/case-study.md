...
capacity-building has many dimensions. we call these dimensions [[aspect|aspects]].[^1] each aspect makes visible one view into the [[processes/Enactment|application]] of practice on-the-ground. we make this visible with currencies. [^2]
...
the potential we're aiming for is for [[hubs]] to grow their self-[[publishing]] capabilities. prisma's role as a distributed incubator is to on-board more hubs into a distributed system of self-organising action-learning journeys, each hub growing their ambition over time to address higher orders of [[index|outcome aims]]. 
### Form
case-studies are an interface into [[action-learning]] - real-time, with multiple perspectives. 
